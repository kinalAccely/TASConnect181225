...
const TopHeader = ({ isLeftCollapsed }) => {
  return (
    ...
    <header className={`flex flex-col gap-6 mb-2 rounded-3xl border border-zinc-200 bg-white/90 ${isLeftCollapsed ? "py-4 px-4" : "px-6 py-5"} backdrop-blur-lg transition-colors md:flex-row md:items-center md:justify-between`}>
